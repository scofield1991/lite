"""
Django settings for lite_project project.
...
SECRET_KEY = 'q)uey8$0a52)kxq=uqkxbp983rxyr+&2guqywk8=d^&2_^s#j)'
...
ROOT_URLCONF = 'lite_project.urls'

WSGI_APPLICATION = 'lite_project.wsgi.application'
